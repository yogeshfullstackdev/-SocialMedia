...
@section('content')
    <h1>Author's {{ $user->name }}'s Profile</h1>
    ...
    <!-- User's Posts -->
    <h2 class="mt-4">Author's Posts</h2>
    ...
    <div class="row mt-4">
        <div class="col-md-6">
            <h3>Author's Followers ({{ $user->followers->count() }})</h3>
            <ul class="list-group">
                @foreach($user->followers as $follower)
                    <li class="list-group-item">
                        <a href="{{ route('profile', ['id' => $follower->follower->id]) }}">
        ...
        <div class="col-md-6">
            <h3>Author's Following ({{ $user->following->count() }})</h3>
            <ul class="list-group">
                @foreach($user->following as $followed)
                    <li class="list-group-item">
                        <a href="{{ route('profile', ['id' => $followed->following->id]) }}">
